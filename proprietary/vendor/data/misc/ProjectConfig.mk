...
CUSTOM_PROJECT_TP9131 = yes
TPLINK_PRO = tp9131a
CUSTOM_HAL_EEPROM = dummy_eeprom
CUSTOM_HAL_FLASHLIGHT = dummy_flashlight
CUSTOM_HAL_IMGSENSOR = s5k3l8_mipi_raw s5k3l6_mipi_raw s5k5e8yx_mipi_raw
CUSTOM_HAL_LENS = dw9714af dummy_lens
CUSTOM_HAL_MAIN2_IMGSENSOR = s5k5e8yx_mipi_raw
...
CUSTOM_KERNEL_IMGSENSOR = s5k3l8_mipi_raw s5k3l6_mipi_raw s5k5e8yx_mipi_raw
...
CUSTOM_MAGNETOMETER_MMC5603_LIB = yes
...
CUSTOM_MODEM=TK_MD_BASIC_LWTG_6177M_R3_6762
...
MTK_FINGERPRINT_SELECT = sunwave
MNTL_SUPPORT = no
...
SPROCOMM_AW8898_AWINIC_MEC = yes
SPROCOMM_AW8898_AWINIC_SKT_V2 = yes
...
# [houjihai start] Close mtk background power saving
...
# [linyimin] Support arcsoft fusion
...
# [houjihai] Remove mtk filemanager
...
# [yangqing start]
TPLINK_TPWLAN_SUPPORT = yes
TPLINK_CRITICAL_POINT_INERTANCE_SUPPORT = yes
# [yangqing end]

# [yanlin start] ROM8.1: Optimize dispatching events for TPFullScreenGesture
TPLINK_OPTIMIZE_TPFULLSCREENGESTURE = yes
# [yanlin end]

# [yanlin start] Enable three finger screenshot by default
TPLINK_THREE_FINGER_SCREENSHOT_SUPPORT = yes
# [yanlin end]

# [yanlin start] Support screen brightness powersave switch
TPLINK_NOTIFICATION_BRIGHTNESS_DIM_SUPPORT = yes
TPLINK_POWERSAVE_BRIGHTNESS_DIM_SUPPORT = yes
# [yanlin end]

# [yanlin start] Enable TP firmware hotfix by default
TPLINK_TP_FIRMWARE_HOTFIX_SUPPORT = yes
# [yanlin end]

# [wuzehui start] for tpfilesystem
TPLINK_FILESYSTEM_SUPPORT = yes
# [wuzehui end]

# [zhangjiawei start] Enable MTP dialog by default
TPLINK_MTP_DIALOG_SUPPORT = yes
# [zhangjiawei end]

# [luomingwei start] for number in RTL
TPLINK_RTL_NUMBER_SUPPORT = yes
# [luomingwei end]

# [zhuliang start]
TPLINK_HUGE_FONT_SIZE_SUPPORT = yes
# [zhuliang end]

# [zhuliang start]
TPLINK_SYSTEMUI_DATA_COLLECTOR_SUPPORT = yes
# [zhuliang end]

# [wuzhong start]
TPLINK_FULL_SCREEN_GESTURE_SUPPORT = yes
TPLINK_AUTO_BRIGHTNESS_SUPPORT = yes
TPLINK_FLOAT_BUTTON_SUPPORT = yes
TPLINK_MULTI_APP_SUPPORT = yes
TPLINK_SCREENOFF_GESTURE_SUPPORT = yes
TPLINK_TPSETTINGS_HOT_FIX_SUPPORT = yes
TPLINK_TPWLAN_SUPPORT = yes
# [wuzhong end]

# [mawenxuan start]
TPLINK_CLIPEBOARD_AUTOLINK_SUPPORT = yes
# [mawenxuan end]

# [wuhefeng start]
TPLINK_MP3_RECORD_SUPPORT = yes
TPLINK_MP3_ENCODE_ID3V2TAG_SUPPORT = yes
# [wuhefeng end]

# [wangshun start]
TPLINK_APPLOCK_SUPPORT = yes
TPLINK_FACEUNLOCK_SUPPORT = yes
# [wangshun end]

# [mawenxuan start]
TPLINK_LONG_SCREENSHOT_SUPPORT = yes
# [mawenxuan end]

# [houjihai start] Add offscreen clean and app alarm switch
TPLINK_OFF_SCREEN_CLEANUP_SUPPORT=yes
TPLINK_APP_ALARM_SUPPORT=yes
# [houjihai end]

# [laifeilong start] Add switch for ehplmn hot-fix
TPLINK_EHPLMN_HOT_FIX = yes
# [laifeilong end] Add switch for ehplmn hot-fix

# [luodinglun start] for theme icon
TPLINK_THEME_ICON_SUPPORT = yes
# [luodinglun end]

# [dingtao start] Enable switch by default
TPLINK_TPPUSH_SUPPORT = yes
# [dingtao end]

# [liudaqiang start] Switch for TPHarassmentfilter
TPLINK_HARASSMENTFILTER_SUPPORT = yes
# [liudaqiang end] Switch for TPHarassmentfilter

# [yuwenjiao start]
TPLINK_RECORD_BIG_VIDEO_SUPPORT = yes
# [yuwenjiao end]

# [liudaqiang start] Add switch for APN hotfix
TPLINK_APN_HOTFIX_SUPPORT = yes
# [liudaqiang end] Add switch for APN hotfix

# [yangqing start] Enable WiFi/BT firmware hotfix by default
TPLINK_WIFI_BT_FIRMWARE_HOTFIX_SUPPORT = yes
# [yangqing end]

# [taoyancheng start] start manager
TPLINK_AUTOSTART_MANAGER_SUPPORT = yes
# [taoyancheng end]

# [yuwenjiao start] Add switch for audioparam hotfix
TPLINK_AUDIO_PARAM_HOTFIX_SUPPORT = yes
# [yuwenjiao end]

# [linyimin] Add tplink hdr
TPLINK_ALGO_HDR_SUPPORT=yes

# [linyimin] Use tplink hdr
TPLINK_ALGO_HDR_ENABLE=yes

# [linyimin] Add scene recognition
TPLINK_ALGO_SCENERECOGNITION_SUPPORT = yes

# [huangxiancong start] add camera algo switch
TPLINK_HAL_ALGO_HDR_PREVIEW = yes
TPLINK_HAL_ALGO_HDR_CAPTURE = yes
TPLINK_HAL_ALGO_NIGHT_PREVIEW = yes
TPLINK_HAL_ALGO_NIGHT_CAPTURE = yes
TPLINK_HAL_ALGO_BEAUTY_PREVIEW = yes
TPLINK_HAL_ALGO_BEAUTY_CAPTURE = yes
TPLINK_HAL_ALGO_SINGLEBOKEN_PREVIEW = yes
TPLINK_HAL_ALGO_SINGLEBOKEN_CAPTURE = yes
TPLINK_HAL_ALGO_STREAMER_PREVIEW = no
TPLINK_HAL_ALGO_STREAMER_CAPTURE = no
TPLINK_HAL_ALGO_PANORAMA = no
TPLINK_HAL_ALGO_DRO = yes
TPLINK_HAL_ALGO_SRAUTO = yes
TPLINK_HAL_ALGO_BESTIMAGE = yes
# [huangxiancong end] add camera algo switch

# [huangxiancong] set cshot version
TPLINK_CONFIG_CSHOT_VERSION = 1

# [lifeiping] for scene recognition effect
TPLINK_SR_EFFECT_SUPPORT = yes
